...
*Setup instructions for a gitian build of Sierra using a Debian VM or physical system.*
...
- [Building Sierra](#building-sierra)
...
Clone the git repositories for Sierra and gitian and then checkout the Sierra version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/sierracoin/sierra-core.git
cd sierra-core
...
Follow the instructions in [doc/release-process.md](release-process.md) in the sierra-core repository
...
To build Sierra (for Linux, OSX, and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the sierra-core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/sierra-core/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/sierracoin/sierra-core
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/sierra-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/sierra-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/sierra-build.assert
```
...
[sierracoin/gitian.sigs](https://github.com/sierracoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
