...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <sierra_address> <monthly_payment_xmx>
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <sierra_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` SIERRA.
