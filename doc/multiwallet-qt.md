...
In order to support loading of multiple wallets in sierra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sierra.cpp.
...
Changes to sierra.cpp
-------------------

sierra.cpp is the entry point into sierra-qt, and as such, will require some minor modifications to provide hooks for
