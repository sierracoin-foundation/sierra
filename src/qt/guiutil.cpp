...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Sierra address (e.g. %1)").arg("SLd5zb7KJewkBNH7xb94r9WHUVrxKiXLcS"));
#endif
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Sierra.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Sierra.lnk
...
{
    return GetAutostartDir() / "sierra.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a sierra.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Sierra\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the Sierra app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add Sierra app to startup item list
