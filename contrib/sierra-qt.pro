...
RESOURCES += src/qt/sierra.qrc src/qt/sierra_locale.qrc

TRANSLATIONS += src/qt/locale/sierra_bg.ts \
                src/qt/locale/sierra_de.ts \
                src/qt/locale/sierra_en.ts \
                src/qt/locale/sierra_es.ts \
                src/qt/locale/sierra_fi.ts \
                src/qt/locale/sierra_fr.ts \
                src/qt/locale/sierra_it.ts \
                src/qt/locale/sierra_ja.ts \
                src/qt/locale/sierra_pl.ts \
                src/qt/locale/sierra_pt.ts \
                src/qt/locale/sierra_ru.ts \
                src/qt/locale/sierra_sk.ts \
                src/qt/locale/sierra_sv.ts \
                src/qt/locale/sierra_vi.ts \
                src/qt/locale/sierra_zh_CN.ts \
                src/qt/locale/sierra_zh_TW.ts